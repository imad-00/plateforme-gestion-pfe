...
urlpatterns = [
    ...
    path("api/admin/", include("apps.defenses.admin_urls")),
    path("api/admin/", include("apps.deliverables.admin_urls")),
    ...
    path("api/super-admin/", include("apps.archives.urls")),
    path("api/super-admin/", include("apps.audit.urls")),
    ...
    path("api/", include("apps.defenses.urls")),
